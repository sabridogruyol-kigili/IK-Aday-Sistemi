...
export default function TalepRow({ talep, redGerekce, benimKullaniciId, benimRolum, baslangicAdaySayisi }: {
    ...
    <>
      <tr className={`border-t border-gray-100 border-l-4 ${DURUM_KENARLIK[talep.durum] ?? "border-l-transparent"} align-top hover:bg-gray-50/50`}>
        ...
        <td className="px-3 py-2.5">
          ...
          {talep.durum === "DURAKLADI" && talep.aktif_gonderim_no < 3 && <RevizyonForm talepId={talep.id} />}
          {talep.durum === "DURAKLADI" && talep.aktif_gonderim_no >= 3 && (
