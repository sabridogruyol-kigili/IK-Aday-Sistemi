...
import { getPersonelDetay, getPersonelPerformansGecmisi } from "../talepler/yeni/actions-cikarma";
...
export default async function BenimPerformansimPage() {
  ...
  const [detay, gecmis] = await Promise.all([
  ...
  return (
    <div className="max-w-3xl">
      ...
      <BenimPerformansimIcerik detay={detay} gecmis={gecmis} adSoyad={me.ad_soyad} />
    </div>
  );
}
